  ...
  return (
    <div className="mt-24">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl w-full md:w-400 p-6 m-3">
          <div className="flex justify-between">
            <p className="text-xl font-semibold">Revenue Sources</p>
          </div>
